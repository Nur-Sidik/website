  ...
  return (
    <main className="min-h-screen bg-cream">
      ...
      <div className="relative h-[70vh] w-full flex flex-col justify-start pt-32 md:justify-center md:pt-32 pb-12">
        <Image
          src="/images/FotoKth.jpeg" // Memakai gambar KTH yang ada di folder public
      ...
      {/* 2. KOTAK INFORMASI / PORTAL BERITA */}
      <section className="py-20 px-6 md:px-12 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-mangrove-dark mb-4">Informasi & Kegiatan</h2>
          <p className="text-foreground/70 max-w-2xl mx-auto">
            Kumpulan dokumentasi dan kabar terbaru mengenai kegiatan Kelompok Tani Hutan.
          </p>
        </div>
